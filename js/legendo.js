...
$(function () {
  ...
  $(window).on("load", function () {
    ...
    setTimeout(function () {
      $(".border-bottom, .border-bottom-wave, #wave").removeClass(
        "bottom-position"
      );
    }, 800);
    setTimeout(function () {
    ...
    setTimeout(function () {
      $(
        ".bottom-credits, .social-icons-wrapper-share, .scroll-indicator-wrapper"
  ...
  $(document).on("click", function (e) {
    let container = $("#navbar-collapse.collapse.in");
  ...
  $(window).on("scroll", function () {
    ...
    if ($(this).scrollTop() > 400) {
      ...
      $(".border-bottom, .border-bottom-wave").addClass(
        "bottom-position-primary"
      );
      ...
      $(".social-icons-wrapper-share").addClass(
      ...
      $(".border-bottom, .border-bottom-wave").removeClass(
        "bottom-position-primary"
      );
      ...
      $(".social-icons-wrapper-share").removeClass(
        "social-icons-wrapper-share-home-call"
      );
    ...
    if ($(this).scrollTop() > 10) {
      $("h1.home-page-title")
        .addClass("home-page-title-hide")
        .removeClass("home-page-title-show");
      $(".scroll-indicator-wrapper").addClass(
        "scroll-indicator-wrapper-position-secondary"
      );
    } else {
      $("h1.home-page-title")
        .removeClass("home-page-title-hide")
        .addClass("home-page-title-show");
      $(".scroll-indicator-wrapper").removeClass(
        "scroll-indicator-wrapper-position-secondary"
      );
    }
